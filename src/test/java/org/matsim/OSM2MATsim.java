...
public class OSM2MATsim {
	...
	private static final String PATH = "C:/Users/avandeloo/Documents/TU/Research/Data/Delft/";
	private static final String INFILE = PATH + "merged-network.osm";
	private static final String OUTFILE = PATH + "merged-network.xml.gz";

	public static void main(final String[] args)
	{
//		// this is a simple version of the code below
//		String osm = "C:/Users/avandeloo/Documents/TU/Research/Data/Delft/merged-network.osm";
//		Config config = ConfigUtils.createConfig();
//		Scenario sc = ScenarioUtils.createScenario(config);
//		Network net = sc.getNetwork();
//		// tnicolai: get name from projection identifiyer (EPSG)
//		CoordinateReferenceSystem crs = MGC.getCRS("EPSG:28992");
...
//		new NetworkWriter(net).write("C:/Users/avandeloo/Documents/TU/Research/Data/Delft/merged-network.xml");
		...
		CoordinateTransformation ct = TransformationFactory.getCoordinateTransformation(TransformationFactory.WGS84,"EPSG:28992");
